<table class="table table-bordered">
    ...
    <tbody> 
      ...
      <tr>
        ...
        <td><input type="text" style="text-align: right;" name="cantidad{{$det->id}}" id="cantidad{{$det->id}}" class="form-control" min="1" value="{{ $det->cantidad}}" onchange="actualiza_producto({{ $det->id}})"></td>
