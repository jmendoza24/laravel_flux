        ...
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    ...
                    {!! Form::button('<i class="fa fa-trash"></i>', ['type' => 'submit', 'class' => 'btn btn-float btn-outline-danger btn-round', 'onclick' => "return confirm('¿Seguro que desea borrar el material?')"]) !!}
                </div>
                {!! Form::close() !!}
            </td>
        </tr>
