        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
              <img class="brand-logo" alt="stack admin logo" src="<?php echo e(url('app-assets/images/logo/fluxmetals.png')); ?>">
  ...
  </div><?php /**PATH C:\wamp64\www\laravel\laravel_flux\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>