  ...
  <div class="col-md-6">
    <div class="card collapse-icon accordion-icon-rotate">
        <div id="headingCollapse12" class="card-header">
          ...
          class="card-title lead collapsed"> VIRTUS Resultados de Prueba  
            <?php $__currentLoopData = $archivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($ar->id_documento == 9): ?>
                 <a href="<?php echo e($ar->archivo); ?>" class="pull-right"> <span class="btn btn-sm btn-outline-success pull-right"><i class="fa fa-file-pdf-o"></i></span></a>
                <?php endif; ?>
        ...
        <div id="headingCollapse13" class="card-header">
          ...
          class="card-title lead collapsed">Evaluación Anual</a>
        </div>
          ...
          <div class="card-content">
            <div class="card-body">
              <table class="table table-striped table-bordered" style="" id="productos-table" style="width: 100%">
                ...
                <tbody>
                  <?php $__currentLoopData = $archivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php if($a->id_documento==12): ?>
                    <tr>
                        <td><a href="<?php echo e($a->archivo); ?>"> <span class="btn btn-sm btn-outline-success pull-right"><i class="fa fa-file-pdf-o"></i></span></a><?php echo e($a->descripcion); ?></td>
  ...
  <div class="col-md-6">
    <div class="card collapse-icon accordion-icon-rotate">
        <div id="headingCollapse11" class="card-header">
          <a data-toggle="collapse" href="#collapse11" aria-expanded="false" aria-controls="collapse11"
          class="card-title lead collapsed"> Resultado Myers Briggs
            <?php $__currentLoopData = $archivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\wamp64\www\laravel\laravel_flux\resources\views/tbl_rhs/evaluaciones.blade.php ENDPATH**/ ?>