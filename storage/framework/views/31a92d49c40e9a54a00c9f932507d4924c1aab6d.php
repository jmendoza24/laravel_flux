<table class="table table-striped table-bordered datacol-basic-initialisation" id="equipoHistorials-table" style="width: 100%">
    <thead>
    ...
    <?php $__currentLoopData = $equipoHistorials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipoHistorial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td>
                <div class='btn-group'>
                    <a href="" data-toggle="modal" data-target="#equipo_historials" onclick="show_historial(<?php echo e($equipoHistorial->tipo); ?>,<?php echo e($equipoHistorial->id); ?>)"  class='btn btn-float btn-outline-success btn-round'><i class="fa fa-edit"></i></a>
...
</table><?php /**PATH /var/www/html/flux/laravel/resources/views/equipo_historials/table.blade.php ENDPATH**/ ?>