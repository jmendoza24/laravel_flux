...
<input type="hidden" name="id_empleado" value="<?php echo e($documentos->id_empleado); ?>">
<input type="hidden" name="tipo" value="<?php echo e($documentos->tipo); ?>">
  <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
          <input type="button" name="" class="btn btn-primary pull-right" value="Cargar" onclick="guardar_catalogos(3,0,<?php echo e($documentos->tipo); ?>,'',<?php echo e($documentos->id_empleado); ?>)" >
        </div>
  </div>
  </form><?php /**PATH C:\wamp64\www\laravel\laravel_flux\resources\views/tbl_rhs/carga_documentos.blade.php ENDPATH**/ ?>