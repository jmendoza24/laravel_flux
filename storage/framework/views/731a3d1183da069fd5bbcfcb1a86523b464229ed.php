        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-md-9">
                  <?php echo Form::text('tcf', null, ['class' => 'form-control']); ?>
           ...
           <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <?php echo Form::text('tc', null, ['class' => 'form-control']); ?>
         ...
         <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-md-9">
                     <?php echo Form::text('t1ct', null, ['class' => 'form-control']); ?>
          ...
          <div class="col-md-6">
           ...
           <div class="col-md-6">
            <div class="form-group row">
              ...
              <div class="col-md-9">
                      <?php echo Form::text('t1cc', null, ['class' => 'form-control']); ?>
         ...
         <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              <label class="col-md-3 label-control" for="userinput1">Teléfono Casa  </label>
              <div class="col-md-9">
                     <?php echo Form::text('t2cc', null, ['class' => 'form-control']); ?>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group row">
              <label class="col-md-3 label-control" for="userinput1">Teléfono Celular</label>
              <div class="col-md-9">
                      <?php echo Form::text('t2ct', null, ['class' => 'form-control']); ?>
        ...
        <div class="row">
              ...
              <div class="col-md-6">
                 <div class="form-group row">
                  <label class="col-md-3 label-control" for="nombre">Porcentaje</label>
                  <div class="col-md-9">
                    <?php echo Form::text('porcentaje2', null, ['class' => 'form-control']); ?>
        ...
        <div class="row">
              ...
              <div class="col-md-6">
                 <div class="form-group row">
                  <label class="col-md-3 label-control" for="nombre">Porcentaje</label>
                  <div class="col-md-9">
                    <?php echo Form::text('porcentaje3', null, ['class' => 'form-control']); ?>
...
<?php /**PATH /var/www/html/flux/laravel/resources/views/tbl_rhs/fields.blade.php ENDPATH**/ ?>