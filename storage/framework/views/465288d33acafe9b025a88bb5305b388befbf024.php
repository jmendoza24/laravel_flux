...
<?php endif; ?>
 ...
 <script src="<?php echo e(url('app-assets/vendors/js/vendors.min.js')); ?>" type="text/javascript"></script>
  ...
  <script src="<?php echo e(url('funciones/jquery.SimpleMask.js')); ?>" type="text/javascript"></script>
  <script src="<?php echo e(url('funciones/funciones.js')); ?>" type="text/javascript"></script>
  <script src="<?php echo e(url('funciones/ordenes_compra.js')); ?>" type="text/javascript"></script>  
  <script src="<?php echo e(url('app-assets/js/scripts/modal/components-modal.js')); ?>" type="text/javascript"></script>
...
<div class="modal fade" id="primary" tabindex="-1" role="dialog" aria-labelledby="myModalLabel8" aria-hidden="true">
  <div class="modal-dialog modal-xl modal-dialog-centered" role="document" id="modal_primary">
...
<div class="modal fade" id="default" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document" id="modal_default"> 
    <div class="modal-content">
      <div class="modal-header bg-primary white">
        <h4 class="modal-title" id="titulo_default"></h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body" id="default_contenido"></div>
    </div>
  </div>
</div><?php /**PATH C:\wamp64\www\laravel\laravel_flux\resources\views/layouts/app.blade.php ENDPATH**/ ?>